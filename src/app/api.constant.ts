export class ApiConstants {
  ...
  public static initiate_quotes(): string {
    ...
    return isCommercial == 'commercial_vehicle'
      ? `/cv/api/v1/initiate_quotes/`
      : `/api/v1/initiate_quotes/`;
  }
  ...
  public static getExpiringPolicy(): string {
    const isCommercial = sessionStorage.getItem('vehicleType');
    return isCommercial == 'commercial_vehicle'
      ? `/cv/api/v1/get_previous_expiry_type/`
      : `/api/v1/get_previous_expiry_type/`;
  }
  ...
  public static get_vehicle_mmv(): string {
    const isCommercial = sessionStorage.getItem('vehicleType');
    return isCommercial == 'commercial_vehicle'
      ? `/cv/api/v1/vehicle_search/`
      : `/api/v1/vehicle_search/`;
  }
  ...
  public static registration_number(): string {
    const isCommercial = sessionStorage.getItem('vehicleType');
    return isCommercial == 'commercial_vehicle'
      ? `/cv/api/v1/vaahan/registration_number/`
      : `/api/v1/vaahan/registration_number/`;
  }
  // public static get_rto_list: string = `/api/v1/rto_search/`;
  public static get_rto_list(): string {
    const isCommercial = sessionStorage.getItem('vehicleType');
    return isCommercial == 'commercial_vehicle'
      ? `/cv/api/v1/rto_search/`
      : `/api/v1/rto_search/`;
  }
  ...
  public static get_previous_insurer(): string {
    const isCommercial = sessionStorage.getItem('vehicleType');
    return isCommercial == 'commercial_vehicle'
      ? `/cv/api/v1/insurer_search/`
      : `/api/v1/insurer_search/`;
  }
  ...
  public static fetch_ckyc_data(): string {
    const isCommercial = sessionStorage.getItem('vehicleType');
    return isCommercial == 'commercial_vehicle'
      ? `/cv/api/v1/ckyc/fetch_ckyc_data/`
      : `/api/v1/ckyc/fetch_ckyc_data/`;
  }
  // public static document_type: string = `/api/v1/document_type/`;
  public static document_type(): string {
    const isCommercial = sessionStorage.getItem('vehicleType');
    return isCommercial == 'commercial_vehicle'
      ? `/cv/api/v1/document_type/`
      : `/api/v1/document_type/`;
  }
  ...
  public static proposal_type(): string {
    const isCommercial = sessionStorage.getItem('vehicleType');
    return isCommercial == 'commercial_vehicle'
      ? `/cv/api/v1/proposer_type/`
      : `/api/v1/proposer_type/`;
  }
  // get expiry policy
  ...
  public static getCoverageType(): string {
    const isCommercial = sessionStorage.getItem('vehicleType');
    return isCommercial == 'commercial_vehicle'
      ? `/cv/api/v1/get_coverage_types/`
      : `/api/v1/get_coverage_types/`;
  }
  ...
  public static expiry_policy_list(): string {
    const isCommercial = sessionStorage.getItem('vehicleType');
    return isCommercial == 'commercial_vehicle'
      ? `/cv/api/v1/master/exp_policy_type/`
      : `/api/v1/master/exp_policy_type/`;
  }
  ...
  public static send_communication(): string {
    const isCommercial = sessionStorage.getItem('vehicleType');
    return isCommercial == 'commercial_vehicle'
      ? `/cv/api/v1/spear/send_communication/`
      : `/api/v1/spear/send_communication/`;
  }
  ...
  public static get_renewal_data(): string {
    const isCommercial = sessionStorage.getItem('vehicleType');
    return isCommercial == 'commercial_vehicle'
      ? `/cv/api/v1/renewals/get_previous_vehicle_details/`
      : `/api/v1/renewals/get_previous_vehicle_details/`;
  }
  // public static fetch_trace_Id = `/api/v1/fetch_quote_request/`;
  public static fetch_trace_Id(): string {
    const isCommercial = sessionStorage.getItem('vehicleType');
    return isCommercial == 'commercial_vehicle'
      ? `/cv/api/v1/fetch_quote_request/`
      : `/api/v1/fetch_quote_request/`;
  }
